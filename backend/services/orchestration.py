...
class OrchestrationService:
    ...
    def register_handler(self, agent_type: str, action: str, handler: Callable) -> None:
...
class WorkflowTemplates:
    ...
    @staticmethod
    def security_scan_workflow(target: str) -> List[Dict[str, Any]]:
        return [
            {
    ...
    @staticmethod
    def diagnostic_workflow(cluster: str) -> List[Dict[str, Any]]:
        return [
            {
                "id": "collect",
